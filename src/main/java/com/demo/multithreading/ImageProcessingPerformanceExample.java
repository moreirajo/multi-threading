...
/**
 * Processing the image by recolor the flowers. We can observe that more than one thread it's
 * quicker. But having more threads that the number of cores doesn't have an impact on performance.
 * Also, if the file has less resolution increasing the number of threads could actually decrease
 * performance, because creating threads as a cost.
 */
public class ImageProcessingPerformanceExample {
